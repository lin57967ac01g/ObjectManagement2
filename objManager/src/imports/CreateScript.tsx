import svgPaths from "./svg-v7av3y3gkp";
    ...
    <div className={className} data-name=".Row">
      ...
      <div className="bg-[#e8e8e8] content-stretch flex flex-col h-[40px] items-start justify-center relative shrink-0 w-[118px]" data-name="Cell">
        ...
        <div className="relative shrink-0 w-full" data-name="Content">
          <div className="overflow-clip rounded-[inherit] size-full">
            <div className="box-border content-stretch flex items-start px-[12px] py-[10px] relative w-full">
              <p className="basis-0 font-['Inter:Regular',sans-serif] font-normal grow leading-[1.3] min-h-px min-w-px not-italic relative shrink-0 text-[#484848] text-[18px]">Action</p>
            </div>
          </div>
        </div>
      </div>
...
function DataSubject() {
  return (
    <div className="content-stretch flex gap-[20px] h-[39px] items-center relative shrink-0 w-[659px]" data-name="DataSubject">
      ...
      <div className="bg-white h-[39px] relative rounded-[10px] shrink-0 w-[520px]" data-name="Tool Type Input">
        <div aria-hidden="true" className="absolute border border-[#cfcfcf] border-solid inset-0 pointer-events-none rounded-[10px]" />
      </div>
    </div>
  );
...
function AttributesContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start overflow-clip relative shrink-0 w-[722px]" data-name="Attributes Container">
...
function SelectedIntentionRow() {
  return (
    <div className="bg-[rgba(255,255,255,0)] content-stretch flex h-[40px] items-start overflow-clip relative shrink-0 w-full" data-name="Selected Intention Row">
      <Cell />
      <Cell1 />
      <Cell2 />
    </div>
  ...
  return (
    <div className="bg-[#363636] relative rounded-[4px] shrink-0 w-full" data-name="Table">
      <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] w-full">
        <Row className="bg-[rgba(255,255,255,0)] content-stretch flex h-[40px] items-start overflow-clip relative shrink-0 w-full" />
...
function Table1() {
  return (
    <div className="content-stretch flex flex-col h-[98px] items-start relative shrink-0 w-[728px]" data-name="Table 1">
      <Table />
      <div className="absolute left-[625px] size-[24px] top-[48px]" data-name="Vector">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
          <g id="Vector">
            <path d={svgPaths.pd213500} fill="var(--fill-0, #323232)" />
          </g>
        </svg>
      </div>
    </div>
  ...
  return (
    <div className="bg-[#363636] relative rounded-[4px] shrink-0 w-full" data-name="Table">
      <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] w-full">
        ...
        <IntentionPoolRow2 />
        <IntentionPoolRow3 />
        <div className="absolute h-[102px] left-[624px] top-[48px] w-[24px]" data-name="Vector">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 102">
            <g id="Vector">
              <path d={svgPaths.pdfe3500} fill="var(--fill-0, #323232)" />
              <path d={svgPaths.p19c05900} fill="var(--fill-0, #323232)" />
              <path d={svgPaths.p1c425072} fill="var(--fill-0, #323232)" />
            </g>
          </svg>
        </div>
      </div>
...
function IntentionMappingContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] h-[388px] items-start overflow-clip relative shrink-0 w-[722px]" data-name="Intention Mapping Container">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[20px] not-italic relative shrink-0 text-[#0009ad] text-[24px] text-nowrap tracking-[0.1px] whitespace-pre">Intention Mapping</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.3] not-italic relative shrink-0 text-[18px] text-black text-nowrap whitespace-pre">Selected Intentions</p>
      <Table1 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.3] not-italic relative shrink-0 text-[18px] text-black text-nowrap whitespace-pre">Intention Pool</p>
      <Table2 />
    </div>
  );
}
...
function Button() {
  return (
    <div className="absolute bg-[#1d89ff] box-border content-stretch flex gap-[8px] h-[43px] items-center justify-center left-[608px] overflow-clip p-[12px] rounded-[8px] top-[751px] w-[139px]" data-name="Button">
...
function Button1() {
  return (
    <div className="absolute bg-[#e8e8e8] box-border content-stretch flex gap-[8px] h-[43px] items-center justify-center left-[439px] overflow-clip p-[12px] rounded-[8px] top-[751px] w-[139px]" data-name="Button">
...
export default function CreateScript() {
  return (
    <div className="bg-white relative rounded-[20px] size-full" data-name="Create Script">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[20px] items-start overflow-clip px-[40px] py-[24px] relative size-full">
          <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[32px] text-black text-nowrap whitespace-pre">Create/Edit Script</p>
          <ScenarioSelection />
          <AttributesContainer />
