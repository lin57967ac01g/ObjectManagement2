import svgPaths from "./svg-ctrc43hk3w";
...
function DiagnosisScript() {
  return (
    <div className="bg-[#e8e8e8] box-border content-stretch flex gap-[10px] h-[80px] items-center px-[10px] py-0 relative shrink-0 w-[320px]" data-name="Diagnosis Script">
      <AiBook />
...
function Button() {
  return (
    <div className="absolute bg-[#1d89ff] box-border content-stretch flex gap-[8px] h-[43px] items-center justify-center left-[1332px] overflow-clip p-[12px] rounded-[8px] top-[76px] w-[198px]" data-name="Button">
      <Plus />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-none not-italic relative shrink-0 text-[20px] text-neutral-100 text-nowrap whitespace-pre">Create Script</p>
    </div>
  );
}
      ...
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex items-start px-[12px] py-[10px] relative w-full">
          <div className="basis-0 flex flex-col font-['Inter:Regular',sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#484848] text-[18px]">
            <p className="leading-[1.3]">Chart Group</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Content">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex items-start px-[12px] py-[10px] relative w-full">
          <div className="basis-0 flex flex-col font-['Inter:Regular',sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#484848] text-[18px]">
            <p className="leading-[1.3]">Pattern Type</p>
          </div>
        </div>
      </div>
    </div>
...
function Cell1() {
  return (
    <div className="bg-[#e8e8e8] content-stretch flex flex-col h-[55px] items-start justify-center relative shrink-0 w-[360px]" data-name="Cell">
      <div aria-hidden="true" className="absolute border-[#cfcfcf] border-[1px_0px_0px_1px] border-solid inset-0 pointer-events-none" />
      <Content1 />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Content">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex items-start px-[12px] py-[10px] relative w-full">
          <div className="basis-0 flex flex-col font-['Inter:Regular',sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#484848] text-[18px]">
            <p className="leading-[1.3]">Tool Type</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Content">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex items-start px-[12px] py-[10px] relative w-full">
          <div className="basis-0 flex flex-col font-['Inter:Regular',sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#484848] text-[18px]">
            <p className="leading-[1.3]">chartgroup1</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Content">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex items-start px-[12px] py-[10px] relative w-full">
          <div className="basis-0 flex flex-col font-['Inter:Regular',sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#484848] text-[18px]">
            <p className="leading-[1.3]">patterntype1</p>
          </div>
        </div>
      </div>
    </div>
...
function Cell6() {
  return (
    <div className="bg-white content-stretch flex flex-col h-[55px] items-start justify-center relative shrink-0 w-[360px]" data-name="Cell">
      <div aria-hidden="true" className="absolute border-[#cfcfcf] border-[1px_0px_0px_1px] border-solid inset-0 pointer-events-none" />
      <Content6 />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Content">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex items-start px-[12px] py-[10px] relative w-full">
          <div className="basis-0 flex flex-col font-['Inter:Regular',sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#484848] text-[18px]">
            <p className="leading-[1.3]">tooltype1</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Content">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex items-start px-[12px] py-[10px] relative w-full">
          <div className="basis-0 flex flex-col font-['Inter:Regular',sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#484848] text-[18px]">
            <p className="leading-[1.3]">chartgroup2</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Content">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex items-start px-[12px] py-[10px] relative w-full">
          <div className="basis-0 flex flex-col font-['Inter:Regular',sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#484848] text-[18px]">
            <p className="leading-[1.3]">patterntype12</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Content">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex items-start px-[12px] py-[10px] relative w-full">
          <div className="basis-0 flex flex-col font-['Inter:Regular',sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#484848] text-[18px]">
            <p className="leading-[1.3]">chartgroup3</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Content">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex items-start px-[12px] py-[10px] relative w-full">
          <div className="basis-0 flex flex-col font-['Inter:Regular',sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#484848] text-[18px]">
            <p className="leading-[1.3]">patterntype13</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Content">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex items-start px-[12px] py-[10px] relative w-full">
          <div className="basis-0 flex flex-col font-['Inter:Regular',sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#484848] text-[18px]">
            <p className="leading-[1.3]">tooltype2</p>
          </div>
        </div>
      </div>
    </div>
...
function DiagnosisScriptManagement() {
  return (
    <div className="absolute bg-white h-[1020px] left-[320px] top-[60px] w-[1600px]" data-name="Diagnosis Script Management">
      <div className="box-border content-stretch flex gap-[10px] h-[1020px] items-start overflow-clip px-[30px] py-[20px] relative rounded-[inherit] w-[1600px]">
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[32px] text-black text-nowrap whitespace-pre">Diagnosis Script Management</p>
        <Button />
        <ScenarioSelection />
        <Table1 />
      </div>
...
export default function DiagnosisScriptManagement1() {
  return (
    <div className="bg-white relative size-full" data-name="Diagnosis Script Management">
      <div className="box-border content-stretch flex flex-col gap-[10px] items-center pb-[266px] pt-0 px-0 relative size-full">
        <Title />
        <NavigationBar />
        <DiagnosisScriptManagement />
      </div>
      <div aria-hidden="true" className="absolute border border-[#cfcfcf] border-solid inset-0 pointer-events-none" />
    </div>
  );
