import svgPaths from "./svg-hjbuo5vp5p";
...
function ScenarioSettings() {
  return (
    <div className="bg-[#e8e8e8] box-border content-stretch flex gap-[10px] h-[80px] items-center px-[10px] py-0 relative shrink-0 w-[320px]" data-name="Scenario Settings">
      <Wysiwyg />
...
function Button() {
  return (
    <div className="absolute bg-[#1d89ff] box-border content-stretch flex gap-[8px] h-[43px] items-center justify-center left-[1332px] overflow-clip p-[12px] rounded-[8px] top-[76px] w-[198px]" data-name="Button">
      <Plus />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-none not-italic relative shrink-0 text-[20px] text-neutral-100 text-nowrap whitespace-pre">Create Scenario</p>
    </div>
  );
}
...
function Cell() {
  return (
    <div className="bg-[#e8e8e8] content-stretch flex flex-col h-full items-start justify-center relative shrink-0 w-[200px]" data-name="Cell">
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Content">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex items-start px-[12px] py-[10px] relative w-full">
          <div className="basis-0 flex flex-col font-['Inter:Regular',sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#484848] text-[18px]">
            <p className="leading-[1.3]">Sub-scenario</p>
          </div>
        </div>
      </div>
    </div>
...
function Cell2() {
  return (
    <div className="bg-[#e8e8e8] content-stretch flex flex-col h-[55px] items-start justify-center relative shrink-0 w-[680px]" data-name="Cell">
      <div aria-hidden="true" className="absolute border-[#cfcfcf] border-[1px_0px_0px_1px] border-solid inset-0 pointer-events-none" />
      <Content2 />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Content">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex items-start px-[12px] py-[10px] relative w-full">
          <div className="basis-0 flex flex-col font-['Inter:Regular',sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#484848] text-[18px]">
            <p className="leading-[1.3]">Scenario 01</p>
          </div>
        </div>
      </div>
    </div>
...
function Cell5() {
  return (
    <div className="bg-white content-stretch flex flex-col h-full items-start justify-center relative shrink-0 w-[200px]" data-name="Cell">
      <div aria-hidden="true" className="absolute border-[#cfcfcf] border-[1px_0px_0px_1px] border-solid inset-0 pointer-events-none" />
      <Content5 />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Content">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex items-start px-[12px] py-[10px] relative w-full">
          <div className="basis-0 flex flex-col font-['Inter:Regular',sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#484848] text-[18px]">
            <p className="leading-[1.3]">sub-scen01</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Content">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex items-start px-[12px] py-[10px] relative w-full">
          <div className="basis-0 flex flex-col font-['Inter:Regular',sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#484848] text-[18px]">
            <p className="leading-[1.3]">scene des1</p>
          </div>
        </div>
      </div>
    </div>
...
function Cell7() {
  return (
    <div className="bg-white content-stretch flex flex-col h-[55px] items-start justify-center relative shrink-0 w-[680px]" data-name="Cell">
      <div aria-hidden="true" className="absolute border-[#cfcfcf] border-[1px_0px_0px_1px] border-solid inset-0 pointer-events-none" />
      <Content7 />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Content">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex items-start px-[12px] py-[10px] relative w-full">
          <div className="basis-0 flex flex-col font-['Inter:Regular',sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#484848] text-[18px]">
            <p className="leading-[1.3]">Scenario 02</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Content">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex items-start px-[12px] py-[10px] relative w-full">
          <div className="basis-0 flex flex-col font-['Inter:Regular',sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#484848] text-[18px]">
            <p className="leading-[1.3]">sub-scen02</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Content">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex items-start px-[12px] py-[10px] relative w-full">
          <div className="basis-0 flex flex-col font-['Inter:Regular',sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#484848] text-[18px]">
            <p className="leading-[1.3]">scene des2</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Content">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex items-start px-[12px] py-[10px] relative w-full">
          <div className="basis-0 flex flex-col font-['Inter:Regular',sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#484848] text-[18px]">
            <p className="leading-[1.3]">Scenario 03</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Content">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex items-start px-[12px] py-[10px] relative w-full">
          <div className="basis-0 flex flex-col font-['Inter:Regular',sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#484848] text-[18px]">
            <p className="leading-[1.3]">sub-scen03</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Content">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex items-start px-[12px] py-[10px] relative w-full">
          <div className="basis-0 flex flex-col font-['Inter:Regular',sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#484848] text-[18px]">
            <p className="leading-[1.3]">scene des3</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-white h-[220px] relative rounded-[4px] shrink-0 w-full" data-name="Table">
      <div className="content-stretch flex flex-col h-[220px] items-start overflow-clip relative rounded-[inherit] w-full">
        ...
        <Row2 />
        <Row3 />
        <div className="absolute h-[139px] left-[1335px] top-[68px] w-[30px]" data-name="Vector">
...
function ScenarioManagement() {
  return (
    <div className="absolute bg-white h-[1020px] left-[320px] top-[60px] w-[1600px]" data-name="Scenario Management">
      <div className="box-border content-stretch flex gap-[10px] h-[1020px] items-start overflow-clip px-[30px] py-[20px] relative rounded-[inherit] w-[1600px]">
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[32px] text-black text-nowrap whitespace-pre">Scenario Management</p>
        <Button />
        <Table1 />
      </div>
      <div aria-hidden="true" className="absolute border border-[#cfcfcf] border-solid inset-0 pointer-events-none" />
...
export default function ScenarioSettings1() {
  return (
    <div className="bg-white relative size-full" data-name="Scenario Settings">
